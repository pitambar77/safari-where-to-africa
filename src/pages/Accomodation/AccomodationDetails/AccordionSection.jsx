...
//  * @param {Array} sections - Each section includes { title: string, items: array }
//  */
...
//         <div
//           key={index}
//           className="px-4 md:px-10 lg:px-16 xl:px-20 2xl:px-28 flex justify-center py-10"
//         >
//           <FAQSectionContainer title={section.title} items={section.items} />
//         </div>
//       ))}
//     </>
//   );
