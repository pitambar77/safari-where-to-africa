        ...
        <div className="flex justify-end mb-6">
          <div className="flex space-x-2">
            <button
              onClick={goToPrevious}
              disabled={currentIndex === 0}
              className="p-3 rounded-full border border-[#aaa086] text-[#aaa086]
              disabled:opacity-50"
            >
              <IoIosArrowBack />
            </button>
              ...
              >
                <div className="bg-white rounded-md shadow-sm overflow-hidden h-full flex flex-col">
                  <div className="relative">
                    ...
                    />
                    {item.status === "Include" && (
                      <span className="absolute top-3 left-3 bg-[#ae9d71] text-white text-xs font-semibold px-3 py-1 rounded">
                        Included Experience
                      </span>
                    )}
                  </div>
