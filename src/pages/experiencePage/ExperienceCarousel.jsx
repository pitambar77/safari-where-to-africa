...
//   return (
//     <section className="bg-[#faf6ef] py-16 px-4 relative font-serif">
//       {/* --- Quote Section --- */}
//       <div className="max-w-3xl mx-auto text-center mb-14">
//         <p className="text-sm tracking-[2px] uppercase text-[#a2864f] mb-4">
...
//           for me."
//         </p>
//         <p className="font-semibold text-gray-800">Carol K.</p>
//       </div>
...
//         </Swiper>
      ...
      //   {/* --- Navigation Buttons --- */}
      //   <button className="swiper-prev absolute -left-10 top-1/2 -translate-y-1/2 bg-white shadow-md p-3 rounded-full hover:bg-gray-100 transition z-10">
      //     <IoIosArrowBack className="text-[#8a7441]" size={24} />
      //   </button>
      //   <button className="swiper-next absolute -right-10 top-1/2 -translate-y-1/2 bg-white shadow-md p-3 rounded-full hover:bg-gray-100 transition z-10">
      //     <IoIosArrowForward className="text-[#8a7441]" size={24} />
      //   </button>
      // </div>
...
//       {/* --- Pagination Counter --- */}
//       <div className="text-center px-10 text-gray-700 font-light tracking-wider">
