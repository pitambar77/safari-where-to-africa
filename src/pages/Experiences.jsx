...
//   const [selectedRegionId, setSelectedRegionId] = useState(""); // ✅ selected ID regions
...
//     // Arrays with images (icons or images)
...
//     // Attach files for each nested image
//     includes.forEach((inc) => {
//       if (inc.icon) formData.append("includeIcons", inc.icon);
//     });
//     gameDrives.forEach((g) => {
//       if (g.image) formData.append("gameDriveImages", g.image);
//     });
//     highlights.forEach((h) => {
//       if (h.image) formData.append("highlightImages", h.image);
//     });
...
//                 className="border p-2"
//                 onChange={(e) =>
//                   handleChange(i, "icon", e.target.files[0], setIncludes, includes)
//                 }
//               />
//             </div>
//           ))}
//           <button
//             type="button"
//             onClick={() => handleAdd(setIncludes, includes, { name: "", icon: null })}
...
//                 value={g.name}
//                 onChange={(e) =>
//                   handleChange(i, "name", e.target.value, setGameDrives, gameDrives)
//                 }
//               />
//               <textarea
//                 placeholder="Description"
...
//                 value={g.description}
//                 onChange={(e) =>
//                   handleChange(i, "description", e.target.value, setGameDrives, gameDrives)
//                 }
//               />
//               <input
//                 type="number"
...
//                 onChange={(e) =>
//                   handleChange(i, "pricePerPerson", e.target.value, setGameDrives, gameDrives)
//                 }
//               />
//               <input
//                 type="file"
//                 className="border p-2 w-full mt-2"
//                 onChange={(e) =>
//                   handleChange(i, "image", e.target.files[0], setGameDrives, gameDrives)
//                 }
//               />
//             </div>
//           ))}
...
//                 value={h.name}
//                 onChange={(e) =>
//                   handleChange(i, "name", e.target.value, setHighlights, highlights)
//                 }
//               />
//               <textarea
//                 placeholder="Description"
...
//                 value={h.description}
//                 onChange={(e) =>
//                   handleChange(i, "description", e.target.value, setHighlights, highlights)
//                 }
//               />
//               <input
//                 type="file"
//                 className="border p-2 w-full mt-2"
//                 onChange={(e) =>
//                   handleChange(i, "image", e.target.files[0], setHighlights, highlights)
//                 }
//               />
//             </div>
//           ))}
...
const Experiences = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Attach files
    includes.forEach((inc) => inc.icon && formData.append("includeIcons", inc.icon));
    gameDrives.forEach((g) => g.image && formData.append("gameDriveImages", g.image));
    highlights.forEach((h) => h.image && formData.append("highlightImages", h.image));
...
//   // ✅ Safely find selected destination and region
//   const selectedDestination = destinations.find(
//     (d) => d._id === selectedDestinationId
//   );
//   const selectedRegion = selectedDestination?.regions?.find(
...
//     // ✅ Link destination + regionSlug (for backend)
//     formData.append("destinationId", selectedDestinationId);
//     formData.append("regionSlug", selectedRegion.slug);
...
//     // ✅ Includes, Game Drives, Highlights (JSON + files)
//     const includesData = includes.map((inc, i) => ({
//       name: inc.name,
//       icon: inc.icon ? `includeIcons[${i}]` : "",
//     }));
...
//       alert("❌ Failed to create experience. Check console for details.");
//     }
//   };
...
//                 {exp.region?.name || exp.regionSlug || "—"}
//               </p>
//             </div>
//             <button
//               onClick={() => deleteExperience(exp._id).then(fetchExperiences)}
